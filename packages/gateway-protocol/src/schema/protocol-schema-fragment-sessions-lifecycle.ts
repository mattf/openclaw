...
export const SessionLifecycleProtocolSchemas = {
  ...
  SessionsFilesUploadParams: sessions.SessionsFilesUploadParamsSchema,
  SessionsFilesUploadResult: sessions.SessionsFilesUploadResultSchema,
  SessionsFilesDownloadParams: sessions.SessionsFilesDownloadParamsSchema,
  SessionsFilesDownloadResult: sessions.SessionsFilesDownloadResultSchema,
